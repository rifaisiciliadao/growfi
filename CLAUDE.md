...
Live on Goldsky — **team: turinglabs · project: growfi · chain: base-sepolia**. Current version: `growfi/2.3.0` (built locally; not yet redeployed at the time of this entry — the v3 commit landed in `main` but the Goldsky `prod` tag still points at `2.2.0` until the rollout script runs).
