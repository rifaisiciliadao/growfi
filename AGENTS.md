...
- `ProducerRegistry` @ `0x651fb29e69Bde3ADE988e8E75e9A3012272D2de5` from block `25328624` on mainnet; Sepolia testnet uses the dedicated `subgraph.sepolia.yaml` registry address.
